...
//                dd($node->getElementsByTagName('div')[1]);

                $pList = $node->getElementsByTagName('div')[1];
                $pHtml =  Product::generateWidgetProductListHtmlContent([
                    'count' => $node->getAttribute('data-max-items'),
                    'cols' => $node->getAttribute('data-display'),
                    'sort' => $node->getAttribute('data-sort-by'),
