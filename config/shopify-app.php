...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_customers,write_customers,read_products,write_products'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            ...
            'address' => 'https://getamplify.email/webhook/customers-create'
        ],
        [
            'topic' => 'app/uninstalled',
            'address' => 'https://getamplify.email/webhook/app-uninstalled'
        ]
