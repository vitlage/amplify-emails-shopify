            ...
            <ul class="modern-listing">
                @if (!is_null($score))
                    ...
                    <li class="d-flex align-items-center">
                         {{ $count = count($campaign->defaultMailList->has_subscriber) }}
...
{{--                            {{ isset($campaign->run_at) ? App\Library\Tool::formatDateTime($campaign->run_at) : "" }}--}}
                    ...
                    <a href="{{ action('CampaignController@schedule', $campaign->uid) }}" class="btn btn-secondary">{{ trans('messages.edit') }}</a>
                </li>
            </ul>
