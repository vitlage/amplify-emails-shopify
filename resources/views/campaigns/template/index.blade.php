...
@section('content')
            ...
            <div class="sub-section d-flex">
                ...
                <div>
                    <div class="template-thumb-container ml-4">
                        <img class="automation-template-thumb" src="{{ $campaign->template->getThumbUrl() }}?v={{ Carbon\Carbon::now() }}" />
                        <a
    ...
    <a href="{{ action('CampaignController@schedule', ['uid' => $campaign->uid]) }}" class="btn btn-secondary">
        {{ trans('messages.next') }} <span class="material-icons-outlined">
arrow_forward
</span>
    </a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.template-compose').click(function(event) {
            ...
            $('.template-compose-classic').click(function(event) {
                event.preventDefault();
