                                    ...
                                    <div class="steps clearfix mb-5">
                                        <ul role="tablist">
                                            <li role="tab" class="first done" aria-disabled="false" aria-selected="true">
                                                <a id="form-horizontal-t-0" href="#" aria-controls="form-horizontal-p-0"><span class="current-info audible">current step: </span><span class="number">1.</span> Step 1</a>
                                            </li>
                                            <li role="tab" class="last current" aria-disabled="false" aria-selected="false">
                                                <a id="form-horizontal-t-1" href="#" aria-controls="form-horizontal-p-1">
                                                    <span class="number">2.</span> Step 2</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <form action="{{route('step_2.save')}}" method="post" class="form-horizontal">
                                    @csrf
                                    <h2 class="text-semibold my-4">Edit your mail list</h2>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="country" class="form-select required required select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                                                <option value="" data-select2-id="3">Choose</option>
