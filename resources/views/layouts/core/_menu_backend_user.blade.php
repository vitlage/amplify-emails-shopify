<li class="nav-item dropdown">
    <a href="#" class="nav-link d-flex align-items-center ps-3 pe-1 py-3 lvl-1 dropdown-toggle"
        id="content-menu" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="navbar-icon">
            <img src="{{url('images/default_user.png')}}" style="border-radius:100%" class="menu-user-avatar" alt="">
        </i>
        <span>ADMIN</span>
    </a>
    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-bottom top-user-menus" aria-labelledby="content-menu">
        <li class="backdrop backdrop-backend p-4 d-flex align-items-center justify-content-center">
            <img src="{{ url('images/sign-stand.svg') }}" width="80px" />
        </li>
        <li class="p-3" style="width: 300px">
            <div class="d-flex mb-2">
                <div class="big-avatar me-3">
                    <a href="#">
                        <img width="80px" class="" src="{{url('images/default_user.png')}}"
                            style="border-radius:100%"
                            class="menu-user-avatar" alt="">
                    </a>
                </div>
                <div>
                    <a href="#" class="fs-6 fw-600 d-flex align-items-center">
                        <span class="me-3">ADMIN</span>
                    </a>
                    <p class="mb-1 small text-muted">email@email.com</p>
...
{{--        <li class="nav-item" rel0="AccountController/profile"><a href="{{ action("Admin\AccountController@profile") }}" class="dropdown-item d-flex align-items-center">--}}

        <li class="nav-item" rel0="AccountController/api">
            <a href="{{route('api')}}" class="dropdown-item d-flex align-items-center">
            <i class="navbar-icon">
