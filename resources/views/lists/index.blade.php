...
@section('title', trans('messages.lists'))
...
@section('content')
    ...
    <div id="CampaignsIndexContainer" class="listing-form top-sticky"
         data-url="{{ action('ListController@listing') }}"
         per-page="10"
    >
        <div class="d-flex top-list-controls top-sticky-content">
            ...
            <div class="text-end">
                <a href="{{ action("ListController@create") }}" role="button" class="btn btn-secondary">
                    <span class="material-icons-round">
                        add
    ...
    <script>
        var CampaignsIndex = {
            getList: function() {
                return makeList({
                    url: '{{ action('ListController@listing') }}',
