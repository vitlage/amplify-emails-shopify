...
@section('content')
    <div id="ProductsIndexContainer" class="listing-form view-{{ request()->view ? request()->view : 'grid' }}"
        ...
        per-page="{{ App\Product::$itemsPerPage }}"
    >
...
search
            ...
            <div class="text-end d-flex align-items-center">
                ...
                <a href="{{route('syncProduct')}}" role="button" class="btn btn-secondary m-icon">
                    <span class="material-icons-outlined">store</span> Sync Products
                </a>
            </div>
        </div>
