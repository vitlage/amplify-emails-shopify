            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="text-muted">
                        {!! is_object($template->admin) ? '<i class="icon-user-tie" data="admin"></i>' . $template->customer->displayName() : '' !!}
                        {!! is_object($template->customer) ? '<i class="icon-user" data="customer"></i>' . $template->customer->displayName() : '' !!}
                    </div>
{{--                    <span class="text-muted">{{ trans('messages.updated_at') }}: {{ Tool::formatDateTime($template->created_at) }}</span>--}}
                    <span class="text-muted">{{ trans('messages.updated_at') }}: {{ \Carbon\Carbon::parse($template->created_at)->toDateTimeString() }}</span>
                </td>
